...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-xl p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-black mb-2">Data Program Studi</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-black">{{ $prodi->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-black">{{ $fakultas->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card rounded-xl overflow-hidden">
        <div class="p-6 border-b border-white/10">
            <h3 class="text-lg font-semibold text-black">Daftar Program Studi</h3>
        </div>
                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="table-row">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                            <div class="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-black font-semibold text-xs">
                                {{ $loop->iteration }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center">
                                    <span class="text-black font-semibold text-sm">{{ substr($prodis->nama, 0, 1) }}</span>
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-black">{{ $prodis->nama }}</div>
