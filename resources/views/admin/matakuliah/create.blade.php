...
<div class="max-w-4xl mx-auto">
    ...
    <div class="glass-card rounded-xl p-6 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-black">Tambah Mata Kuliah Baru</h2>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select name="semester" 
                            ...
                            <option value="ganjil" {{ old('semester') == 'ganjil' ? 'selected' : '' }} class="bg-gray-800 text-black py-2">Ganjil</option>
                            <option value="genap" {{ old('semester') == 'genap' ? 'selected' : '' }} class="bg-gray-800 text-black py-2">Genap</option>
                        </select>
