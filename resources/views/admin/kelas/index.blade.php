...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-xl p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-black mb-2">Data Kelas</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-black">{{ $kelas->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-black">{{ $kelas->pluck('ruangan')->unique()->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-black">{{ $kelas->pluck('mata_kuliah_id')->unique()->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card rounded-xl overflow-hidden">
        <div class="p-6 border-b border-white/10">
            <h3 class="text-lg font-semibold text-black">Daftar Kelas</h3>
        </div>
                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="table-row">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                            <div class="w-8 h-8 bg-cyan-500 rounded-full flex items-center justify-center text-black font-semibold text-xs">
                                {{ $loop->iteration }}
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-sm font-medium text-black">{{ $k->ruangan }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center">
                                    <span class="text-black font-semibold text-sm">{{ substr($k->mata_kuliah->nama ?? 'N', 0, 1) }}</span>
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-black">{{ $k->mata_kuliah->nama ?? '-' }}</div>
