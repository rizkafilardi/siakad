...
<div class="max-w-4xl mx-auto">
    ...
    <div class="glass-card rounded-xl p-6 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-black">Edit Data Dosen</h2>
                <p class="text-gray-400">Perbarui informasi dosen: <span class="text-pink-400 font-medium">{{ $dosen->nama }}</span></p>
            </div>
        </div>
    </div>
