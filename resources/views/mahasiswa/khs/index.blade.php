...
<div class="min-h-screen w-full bg-gray-900 text-white p-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400">Kartu Hasil Studi - Prestasi Akademik</p>
    </div>
    ...
    <div class="bg-gray-800 rounded-xl p-6 mb-6">
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-400 text-sm">Hasil nilai semester ini</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div class="bg-gray-700 rounded-lg p-4 flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center" style="background-color: #db2777;">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                    </svg>
                </div>
                <div>
                    <p class="text-gray-400 text-sm">IPK Semester</p>
        ...
        <div class="bg-gray-700 rounded-lg overflow-hidden">
                    ...
                    <table class="w-full">
                        <thead style="background-color: #db2777;">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center text-xs font-medium text-white uppercase tracking-wider">Nilai</th>
                            </tr>
                        </thead>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">Semester {{ $item->krs->jadwal->kelas->mata_kuliah->semester ?? '-' }}</p>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        @php
                            ...
                            if($nilai >= 85) {
                                ...
                                $gradeStyle = 'background-color: #ec4899;';
                            } elseif($nilai >= 70) {
                                $gradeColor = 'text-white';
                                $gradeStyle = 'background-color: #db2777;';
                            } elseif($nilai >= 60) {
                        ...
                        @endphp
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $gradeColor }}" @if($gradeStyle) style="{{ $gradeStyle }}" @endif>
                            {{ $nilai }}
                        </span>
                    </td>
                </tr>
            ...
            @empty
                ...
                <div class="p-12 text-center">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style="background-color: #ec4899;">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-white mb-2">Belum Ada Nilai</h3>
                    <p class="text-gray-400 mb-4">Nilai untuk semester ini belum tersedia.</p>
                    <div class="flex items-center justify-center gap-2" style="color: #ec4899;">
    ...
    <div class="bg-gray-800 rounded-xl p-6">
        <div class="flex items-center gap-3 mb-4">
            <div class="w-6 h-6 rounded-lg flex items-center justify-center" style="background-color: #ec4899;">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div class="flex items-center gap-3">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-white" style="background-color: #ec4899;">A</span>
                <span class="text-gray-400 text-sm">85 - 100</span>
            </div>
            <div class="flex items-center gap-3">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-white" style="background-color: #db2777;">B</span>
                <span class="text-gray-400 text-sm">70 - 84</span>
            </div>
            <div class="flex items-center gap-3">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">C</span>
                <span class="text-gray-400 text-sm">60 - 69</span>
            </div>
            <div class="flex items-center gap-3">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">D</span>
                <span class="text-gray-400 text-sm">50 - 59</span>
            </div>
            <div class="flex items-center gap-3">
