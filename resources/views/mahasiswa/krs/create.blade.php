...
<div class="min-h-screen w-full bg-gray-900 text-white p-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400">Pilih mata kuliah untuk semester ini</p>
    </div>
    ...
    <div class="bg-gray-800 rounded-xl p-6 mb-6">
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-400 text-sm">Pilih mata kuliah yang ingin diambil</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-gray-700 rounded-lg p-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-gray-400 text-sm">Mata Kuliah Tersedia</p>
                ...
                <table class="w-full">
                    <thead style="background-color: #db2777;">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-medium text-white uppercase tracking-wider">SKS</th>
                            <th class="px-6 py-4 text-center text-xs font-medium text-white uppercase tracking-wider">Kelas</th>
                            <th class="px-6 py-4 text-center text-xs font-medium text-white uppercase tracking-wider">Jam</th>
                        ...
                        <tr class="hover:bg-gray-600 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-lg flex items-center justify-center text-white text-sm font-bold" style="background-color: #db2777;">
                                        D
                                    </div>
                                    <div>
                                        <p class="text-white font-medium">{{ $item->kelas->mata_kuliah->nama ?? '-' }}</p>
                                        <p class="text-gray-400 text-sm">{{ $item->kelas->mata_kuliah->kode ?? '' }}</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <div class="w-6 h-6 rounded flex items-center justify-center text-white text-xs font-bold" style="background-color: #db2777;">
